...
const Register =()=>{
  ...
  <div className='min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-white'>
      <div className='flex flex-col justify-center items-center px-6 py-12'>
            ...
            <form onSubmit={handleSubmit} className='space-y-6'>
              ...
              <div>
                ...
                <div className='relative'>
                  ...
                  <input type='text' className='w-full border border-gray-300 rounded-md py-2 pl-10 pr-3 focus:outline-none focus:ring-2 focus:ring-blue-500' 
       ...
       {/*Right Side - Pattern*/}
      <AuthImagePattern title={'Join our community!'} subtitle={'Connect with friends and family,share your thoughts, and stay in touch with your loved ones.'}/>
  </div>
